  ...
  const result: FsartAnalysisResult = {
    ...
    treeHmm: {
      ...
      subsetSearch: {
        ...
        nullKey: "0", selectedKey: "0,1", exactVerifiedKeys: ["0", "0,1"], exactSelectedKey: "0,1", elapsedMs: 2,
      },
    ...
    topologyBankAudit: { familyFits: 3, resolvedFits: 3, unresolvedFits: 0, uniqueResolvedTopologies: 2, retainedTopologies: 2, truncatedTopologies: 0, failedProfileScores: 0, maximumAiccStates: 1, fastTreeParallelism: 2 },
