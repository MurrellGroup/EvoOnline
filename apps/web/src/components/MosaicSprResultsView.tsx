...
import { createMosaicSprRecombinationBundle, type EvoOnlineRecombinationTreeBundle } from "../lib/recombination-bundle.js";
...
export function MosaicSprResultsView({ result, onLoadRecombinationTrees }: { readonly result: MosaicSprAnalysisResult; readonly onLoadRecombinationTrees?: ((method: RecombinationCodonMethod, treeSet: RecombinationCodonTreeSet, bundle: EvoOnlineRecombinationTreeBundle) => void) | undefined }) {
  ...
  try { codonTreeSet = createMosaicSprCodonTreeSet(result, result.sites); recombinationBundle = createMosaicSprRecombinationBundle(result, codonTreeSet); }
