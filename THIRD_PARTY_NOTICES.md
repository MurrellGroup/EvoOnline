...
The HTML files contain a small PhyloWorkbench `postMessage` bridge and alivibe's same-repository script references have been made relative. The upstream code is MIT licensed; its license is preserved at `apps/web/public/widgets/LICENSE`.
