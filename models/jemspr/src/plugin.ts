...
export const jemsprManifest: ModelManifest = {
  ...
  parameters: [
    { id: "linkedLikelihood", label: "Linked branch-length ML", description: "After topology/event search, obtain only one fixed whole-alignment GTR matrix from FastTree and fit all coherent network-edge lengths with EvoOnline's own likelihood engine.", type: "boolean", default: true },
    { id: "likelihoodRefinement", label: "Likelihood-refine genomic path", description: "Run EvoOnline forward/backward and Viterbi recursions over the fixed switching network, then refit the shared branch lengths once. Disable to retain the parsimony path exactly.", type: "boolean", default: true },
    ...
    { id: "likelihoodRateCategories", label: "Likelihood rate categories", description: "Custom equal-mass discrete-Gamma categories used by EvoOnline's nucleotide likelihood engine. One disables site-rate variation.", type: "integer", default: 4, minimum: 1, maximum: 8, step: 1, advanced: true },
    { id: "fitLikelihoodGammaShape", label: "Profile Gamma shape", description: "Profile a compact Gamma-shape grid using the custom linked likelihood; no FastTree CAT/Gamma estimate is used.", type: "boolean", default: true, advanced: true },
    { id: "likelihoodGammaShape", label: "Initial/fixed Gamma shape", description: "Starting shape, or the fixed shape when Gamma profiling is disabled.", type: "number", default: 0.5, minimum: 0.05, maximum: 20, step: 0.05, advanced: true },
    { id: "likelihoodIterations", label: "Linked ML iterations", description: "Maximum analytic-gradient L-BFGS iterations for the initial coherent network-edge fit.", type: "integer", default: 28, minimum: 2, maximum: 80, step: 1, advanced: true },
    { id: "likelihoodRefitIterations", label: "Likelihood-path refit iterations", description: "Maximum linked branch-length polishing steps after Gamma profiling and the likelihood path update.", type: "integer", default: 14, minimum: 2, maximum: 40, step: 1, advanced: true },
  ...
  outputKinds: ["rooted-master-tree", "adaptive-rspr-path", "switching-network", "overlapping-event-intervals", "linked-branch-lengths", "likelihood-refined-path", "local-trees", "tree-sequence-edges", "linked-tanglegram", "svg", "csv", "tsv", "json"],
