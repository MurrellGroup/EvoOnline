...
export const fsartManifest: ModelManifest = {
  ...
  parameters: [
    ...
    { id: "maximumTreeHypotheses", label: "Scored full-tree limit", description: "Safety cap on independently fitted full trees. Equal topologies are retained when their branch lengths or Gamma shapes came from different source windows.", type: "integer", default: 48, minimum: 2, maximum: 64, step: 1, advanced: true },
