...
export const fsartManifest: ModelManifest = {
  ...
  parameters: [
    ...
    { id: "maximumTreeHypotheses", label: "Scored full-tree limit", description: "Emergency ceiling on resolved source-window trees passed to all-site likelihood scoring and subset search (default and maximum 1000). Equal topologies remain separate. A run that reaches this ceiling is explicitly reported as truncated.", type: "integer", default: 1000, minimum: 2, maximum: 1000, step: 1, advanced: true },
    { id: "maximumHmmStates", label: "Beam expansion depth", description: "Number of subset-size layers explored with the bounded beam before add/drop/swap floating search (default 12). This is not a maximum hypothesis size: improving floating additions can retain more trees.", type: "integer", default: 12, minimum: 1, maximum: 16, step: 1, advanced: true },
