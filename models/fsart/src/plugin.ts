...
export const fsartManifest: ModelManifest = {
  ...
  parameters: [
    ...
    { id: "maximumHmmStates", label: "Beam expansion depth", description: "Number of subset-size layers explored with the bounded beam before add/drop/swap floating search (default 8). This is not a maximum hypothesis size: improving floating additions can retain more trees.", type: "integer", default: 8, minimum: 1, maximum: 16, step: 1, advanced: true },
