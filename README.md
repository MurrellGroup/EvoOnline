...
7. Running DifFUBAR, FUBAR, fixed three-rate BS-REL, FAME, FLAVOR, Glamma, CladeShift, FSART, or MosaicSPR in dedicated browser workers. Exact parallel WASM is the default for selection models; DifFUBAR and regular FUBAR also retain selectable WebGPU. FSART and MosaicSPR need only an alignment and reuse the existing FastTree bioWASM runtime.
